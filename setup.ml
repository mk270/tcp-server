...
(* OASIS_START *)
(* DO NOT EDIT (digest: cccb9b704a878bdb8b6d767bf0a5d44e) *)
(*
...
let setup_t =
  {
               ...
               Executable
                 ({
                     ...
                     },
                   {
                      ...
                      bs_path = "lib_test";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "tcp_server"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = true; exec_main_is = "test_tcp_server.ml"; 
                   })
            ];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\144?\146\194\183_ \019\018\168\"\176f\003\2396";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
